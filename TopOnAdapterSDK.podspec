...
#
  ...
  s.description      = <<-DESC
      AnyThinkPrivateSDK,Vungle,Kidoz,Ogury
                       DESC
  s.homepage         = 'https://github.com/GPPG/TopOnAdapterSDK.git'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'GUO PENG' => 'ios' }
  s.source           = { :git => 'https://github.com/GPPG/TopOnAdapterSDK.git', :tag => s.version.to_s }
